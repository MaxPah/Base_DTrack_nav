...
namespace Base_DTrack_Nav
{
    class Program
    {
        ...
        static string[][] splitMessage(string t)
        {
            string[] split;
            string[][] split2;
